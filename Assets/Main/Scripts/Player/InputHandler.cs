...
namespace BadJuja.Player {
    ...
    public class InputHandler : MonoBehaviour {
        ...
        {
            _switchToMeleeAction.performed += ctx => GlobalEvents.Send_OnSwitchToAttackType(0);
            _switchToLightAction.performed += ctx => GlobalEvents.Send_OnSwitchToAttackType(1);
            _switchToHeavyAction.performed += ctx => GlobalEvents.Send_OnSwitchToAttackType(2);
        }
